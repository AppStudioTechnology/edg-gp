    ...
    <section className="bg-[#0a0a0a] py-[72px] lg:py-[100px] px-4 sm:px-6 lg:px-[45px] overflow-hidden">
      <div className="max-w-[1440px] mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 lg:gap-20 rounded-[20px] border border-white/8 bg-white/[0.03] px-8 sm:px-12 py-12 lg:py-16"
        >
          ...
          <div className="flex flex-col gap-5 max-w-[640px]">
            ...
            <p className="font-sans text-[15px] lg:text-[17px] text-white/55 leading-[1.7]">
          ...
          <div className="flex flex-col gap-6 shrink-0">
            <div className="flex items-start gap-4 p-6 rounded-[16px] border border-[#ceae5a]/20 bg-[#ceae5a]/5 max-w-[320px]">
